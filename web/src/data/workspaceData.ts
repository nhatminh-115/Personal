...
export const initialChatThreads: ChatThreadRecord[] = [
  { id: 'stateful-main', projectId: 'stateful', title: 'Novelty & architecture', summary: 'Main synthesis across TTT, recurrent memory and latent state.', updated: '18m ago', pinned: true, messages: cloneMessages(chatMessages) },
  { id: 'stateful-ttt', projectId: 'stateful', title: 'TTT overlap deep-dive', summary: 'Where update dynamics overlap and state representation diverges.', updated: '1h ago', messages: researchSeed },
  { id: 'stateful-code', projectId: 'stateful', title: 'Toy prototype benchmark', summary: 'Fixed memory, 16k context sweep and retrieval failure.', updated: '2h ago', messages: codingSeed },
  { id: 'stateful-paper', projectId: 'stateful', title: 'Paper framing', summary: 'Turn evidence into a conservative novelty claim.', updated: 'yesterday', messages: emptySeed('stateful-paper', 'Help me frame the novelty claim conservatively for a paper.') },
  { id: 'aura-main', projectId: 'aura', title: 'Workspace architecture', summary: 'Global workspace vs project-scoped AI interactions.', updated: 'today', pinned: true, messages: emptySeed('aura-main', 'Design AURA as a personal AI workspace, not just a chatbot frontend.') },
  { id: 'aura-board', projectId: 'aura', title: 'Conversation Board UX', summary: 'Branching, context bridges, merge and smart edges.', updated: 'today', messages: emptySeed('aura-board', 'Pressure-test the Conversation Board UX and interaction model.') },
  { id: 'aura-routing', projectId: 'aura', title: 'Routing studio', summary: 'Profiles, model locks, reasoning and inspectability.', updated: 'yesterday', messages: emptySeed('aura-routing', 'What should a routing studio expose without becoming an admin dashboard?') },
  { id: 'transport-main', projectId: 'transportability', title: 'Discussion rewrite', summary: 'Connect observed failures back to transportability preconditions.', updated: 'yesterday', pinned: true, messages: emptySeed('transport-main', 'Help tighten the Discussion around P1–P3 and deployment failures.') },
  { id: 'transport-gas', projectId: 'transportability', title: 'Derived gas outputs', summary: 'eCO₂/TVOC misuse and literature screening.', updated: '2 days ago', messages: emptySeed('transport-gas', 'Explain the derived gas output problem and how to present it carefully.') },
  { id: 'agent-main', projectId: 'personal-agent', title: 'Durable context design', summary: 'Explicit manifests, compaction and tool traces.', updated: '3 days ago', pinned: true, messages: emptySeed('agent-main', 'Design durable context for a personal agent without hiding what was retained.') },
  { id: 'agent-regression', projectId: 'personal-agent', title: 'Memory regression', summary: 'Compaction quality drop under long sessions.', updated: '3 days ago', messages: emptySeed('agent-regression', 'Diagnose the memory compaction quality regression.') },
];
